...
<body>
	...
	${message}
	<form:form action="" modelAttribute="novel"
		enctype="multipart/form-data">
		<div>
			<label>Tên truyện</label> <input name="name" value="${novel.name}" />
		</div>
		<div>
			<label>Quốc gia</label> <input name="country"
				value="${novel.country}" />
		</div>
		<div>
			<label>File ảnh</label>
