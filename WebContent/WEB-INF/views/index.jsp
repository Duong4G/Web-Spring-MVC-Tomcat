...
<body>
	...
	<div id="trangchu" style="height: 50%; margin-right: 5%">
		...
		<table id="dieuhuong" style="margin-bottom: 5%; margin-left: 5%">
			...
			<tr>
				<th class="hinhanh"><a
					href="<c:url value="/novel/chapterlistadmintt/7.htm"/>"><img
						src="<c:url value="/images/hoaxanh.jpg"/>" width="300px"
						height="200px"></a></th>
				<th><a href="<c:url value="/novel/chapterlistadmintt/7.htm"/>"> <span
			...
			<tr>
				<th class="hinhanh"><a
					href="<c:url value="/novel/chapterlistadmintt/12.htm"/>"><img
						src="<c:url value="/images/duongmotchieu.jpg"/>" width="300px"
						height="200px"></a></th>
				<th><a href="<c:url value="/novel/chapterlistadmintt/12.htm"/>"> <span
			...
			<tr>
				<th class="hinhanh"><a
					href="<c:url value="/novel/chapterlistadmintt/14.htm"/>"><img
						src="<c:url value="/images/amhuong.jpg"/>" width="300px"
						height="200px"></a></th>
				<th><a href="<c:url value="/novel/chapterlistadmintt/14.htm"/>"> <span
			...
			<tr>
				<th class="hinhanh"><a
					href="<c:url value="/novel/chapterlistadmintt/0.htm"/>"><img
						src="<c:url value="/images/tamquoc.jpg"/>" width="300px"
						height="200px"></a></th>
				<th><a href="<c:url value="/novel/chapterlistadmintt/0.htm"/>"> <span
			...
			<tr>
				<th class="hinhanh"><a
					href="<c:url value="/novel/chapterlistadmintt/11.htm"/>"><img
						src="<c:url value="/images/thienlinhcai.jpg"/>" width="300px"
						height="200px"></a></th>
				<th><a href="<c:url value="/novel/chapterlistadmintt/11.htm"/>"> <span
			...
			<tr>
				<th class="hinhanh"><a
					href="<c:url value="/novel/chapterlistadmintt/9.htm"/>"><img
						src="<c:url value="/images/matbiec.jpg"/>" width="300px"
						height="200px"></a></th>
				<th><a href="<c:url value="/novel/chapterlistadmintt/9.htm"/>"> <span
			...
			<tr>
				<th class="hinhanh"><a
					href="<c:url value="/novel/chapterlistadmintt/6.htm"/>"><img
						src="<c:url value="/images/deton.jpg"/>" width="300px"
						height="200px"></a></th>
				<th><a href="<c:url value="/novel/chapterlistadmintt/6.htm"/>"> <span
